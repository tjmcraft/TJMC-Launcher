...
const WhatsNewContent = memo(() => (
	<div>
		...
		<h1 className={buildClassName(style.added, style.title)}>НОВЫЕ ФУНКЦИИ </h1>
		<ul>
			<li>
		...
		<h1 className={buildClassName(style.fixed, style.title)}>NITRO И БУСТЫ </h1>
		<ul>
			<li>
		...
		<h1 className={buildClassName(style.progress, style.title)}>СПЕЦИАЛЬНЫЕ ВОЗМОЖНОСТИ И БЕЗОПАСНОСТЬ </h1>
		<ul>
			<li>
		...
		<h1 className={buildClassName(style.progress, style.title)}>И, ПРЕЖДЕ ЧЕМ ЗАКОНЧИТЬ… </h1>
		<ul>
			<li>
